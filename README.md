...
<p align="center">
  <a href="releases/latest/download/xemanh-0.1.3-setup.exe">Tải bản cài Windows</a>
  · Windows 10 / 11
  &nbsp;·&nbsp;
...
1. Tải [bản cài Windows mới nhất](releases/latest/download/xemanh-0.1.3-setup.exe)
